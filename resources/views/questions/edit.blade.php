...
<div class="create-wrap">
    ...
    <div class="create-form">
        ...
        <div style="margin-bottom:20px;">
            <h1 style="font-size:22px;font-weight:800;color:#111827;margin:0 0 4px;">Éditer la question</h1>
            <p style="font-size:13px;color:#9ca3af;margin:0;">
                Modifiez votre question pour la rendre plus claire 📝
            </p>
        </div>
